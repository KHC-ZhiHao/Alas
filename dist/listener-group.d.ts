...
type GetEvent<T> = T extends Model ? T['$on'] : (T extends List<any> ? T['on'] : (T extends Dictionary<any> ? T['on'] : (T extends Main ? T['on'] : (T extends Status<any> ? T['on'] : (T extends Loader<any> ? T['on'] : () => void)))));
